...
const Quiz = ({ quizId = 'lesson7' }) => {
    // Extract questions from data locally if not passed as props (Lesson 7 pattern)
    const mcqQuestions = lesson7Data.mcqQuestions || [];
    const tfQuestions = lesson7Data.tfQuestions || [];
    ...
    // Helper to generate unique ID if missing (Lesson 7 data might rely on index)
    ...
    const getFeedback = () => {
        if (percentage >= 90) return { text: "Excellent! You've mastered Production Function!", class: "excellent" };
        ...
        <section className="lesson-section quiz-section">
            ...
            <div className="section-header-lesson">
                ...
                <p className="section-subtitle-lesson">
                    Answer all questions to check your understanding of Production Function & Returns
                </p>
            </div>
                ...
                <div className="quiz-block">
                    ...
                    <div className="questions-container">
                        {mcqQuestions.map((q, index) => (
                            ...
                            ${showResults && mcqAnswers[index] === idx && idx !== q.correct ? 'wrong' : ''}`}
                                        ...
                                        >
                                            ...
                                            {showResults && mcqAnswers[index] === idx && idx !== q.correct && <FaTimesCircle className="option-icon wrong" />}
                                        </button>
                                    ))}
                                </div>
                            </div>
            ...
            {tfQuestions.length > 0 && (
                <div className="quiz-block">
                    ...
                    <div className="questions-container">
                        ...
                        ${showResults && tfAnswers[index] === true && !q.correct ? 'wrong' : ''}`}
                        ...
                        ${showResults && tfAnswers[index] === false && q.correct ? 'wrong' : ''}`}
                        ...
                        <div className="results-breakdown">
                            <div className="breakdown-item">
                                ...
                                <span className="breakdown-value">
                                    {mcqQuestions.filter((q, i) => mcqAnswers[i] === q.correct).length}/{Object.keys(mcqAnswers).length}
                                </span>
                            </div>
                            <div className="breakdown-item">
                                <span className="breakdown-label">True/False Score</span>
                                <span className="breakdown-value">
                                    {tfQuestions.filter((q, i) => tfAnswers[i] === q.correct).length}/{Object.keys(tfAnswers).length}
                                </span>
                            </div>
                        </div>
