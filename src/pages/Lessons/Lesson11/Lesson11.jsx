...
import { FaArrowLeft, FaTruck, FaChartLine, FaClipboardList, FaChevronLeft, FaChevronRight } from 'react-icons/fa';
...
const sections = [
    { id: 'intro', name: 'Concept of Supply', icon: FaTruck },
    { id: 'law', name: 'Law of Supply', icon: FaChartLine },
    { id: 'quiz', name: 'Quiz', icon: FaClipboardList }
];

function Lesson11() {
    const [activeSection, setActiveSection] = useState(() => localStorage.getItem('lesson11-activeSection') || 'intro');
    ...
    const renderActiveSection = () => {
        switch (activeSection) {
            case 'intro': return <div className="content-card"><h2>Theory of Supply</h2><p>Coming Soon...</p></div>;
        ...
        <div className="lesson-page">
            <header className="lesson-header">
                <div className="header-container">
                    ...
                    <h1 className="lesson-title">Theory of Supply</h1>
                </div>
            </header>
