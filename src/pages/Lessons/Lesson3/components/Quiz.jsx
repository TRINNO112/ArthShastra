// Quiz Module - Consumer Equilibrium: Utility Analysis (VK Ohri Grade 11)
...
function Quiz({ mcqQuestions, tfQuestions, quizId = 'lesson3' }) {
  ...
  const getFeedback = () => {
    if (percentage >= 90) return { text: "Excellent! You've mastered Consumer Equilibrium!", class: "excellent" };
    ...
    <section className="lesson-section quiz-section">
      ...
      <div className="section-header-lesson">
        ...
        <p className="section-subtitle-lesson">
          Answer all questions to check your understanding of Consumer Equilibrium
        </p>
      </div>
